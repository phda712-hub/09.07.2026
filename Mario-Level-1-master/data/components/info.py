...
class OverheadInfo(object):
    ...
    def get_stage_string(self):
        """Builds the world-stage label (e.g. '1-1', '1-2') from the
        current level number stored in game_info"""
        level_num = self.game_info.get(c.LEVEL_NUM, 1)
        return '1-' + str(level_num)
    ...
    def create_info_labels(self):
        ...
        self.create_label(self.stage_label, self.get_stage_string(), 472, 55)
    ...
    def create_load_screen_labels(self):
        ...
        self.create_label(number_label, self.get_stage_string(), 430, 200)
